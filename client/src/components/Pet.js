...
class Pet extends Component {
	...
	render() {
		const { pet, adopter, index } = this.props;
		...
		return (
			<div className='panel-body'>
				<img
					...
					style={{ width: '100%' }}
					src={dogImageMap(pet.picture)}
					data-holder-rendered='true'
				/>
				<strong>Breed</strong>: <span className='pet-breed'>{pet.breed}</span>
				<br />
				<strong>Age</strong>: <span className='pet-age'>{pet.age}</span>
				<br />
